...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      {/* Hero Section */}
      <section className="relative w-full h-[calc(100vh-5rem)] h-[calc(100dvh-5rem)] md:h-[calc(100vh-5.5rem)] md:h-[calc(100dvh-5.5rem)] xl:h-[calc(100vh-6rem)] xl:h-[calc(100dvh-6rem)] bg-gradient-to-br from-[#f7faf8] via-[#ffffff] to-[#eff5f1] dark:from-zinc-950 dark:to-zinc-900 overflow-hidden flex flex-col font-sans select-none justify-between border-b border-zinc-200/30 dark:border-zinc-800/20">
